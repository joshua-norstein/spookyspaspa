...
// src/node_modules/motion-utils/dist/es/array.mjs
...
// src/node_modules/motion-utils/dist/es/clamp.mjs
var clamp = (min, max, v) => {
  if (v > max)
    return max;
  if (v < min)
...
// src/node_modules/motion-utils/dist/es/format-error-message.mjs
function formatErrorMessage(message, errorCode) {
  return errorCode ? `${message}. For more information and steps for solving, visit https://motion.dev/troubleshooting/${errorCode}` : message;
}

// src/node_modules/motion-utils/dist/es/errors.mjs
var warning = () => {
};
var invariant = () => {
};
...
// src/node_modules/motion-utils/dist/es/global-config.mjs
var MotionGlobalConfig = {};

// src/node_modules/motion-utils/dist/es/is-numerical-string.mjs
var isNumericalString = (v) => /^-?(?:\d+(?:\.\d+)?|\.\d+)$/u.test(v);

// src/node_modules/motion-utils/dist/es/is-object.mjs
function isObject(value) {
  return typeof value === "object" && value !== null;
}

// src/node_modules/motion-utils/dist/es/is-zero-value-string.mjs
var isZeroValueString = (v) => /^0[^.\s]+$/u.test(v);

// src/node_modules/motion-utils/dist/es/memo.mjs
...
// src/node_modules/motion-utils/dist/es/noop.mjs
var noop = (any) => any;

// src/node_modules/motion-utils/dist/es/pipe.mjs
var combineFunctions = (a, b) => (v) => b(a(v));
var pipe = (...transformers) => transformers.reduce(combineFunctions);

// src/node_modules/motion-utils/dist/es/progress.mjs
var progress = (from, to, value) => {
  const toFromDifference = to - from;
  return toFromDifference === 0 ? 1 : (value - from) / toFromDifference;
};

// src/node_modules/motion-utils/dist/es/subscription-manager.mjs
...
// src/node_modules/motion-utils/dist/es/time-conversion.mjs
var secondsToMilliseconds = (seconds) => seconds * 1e3;
var millisecondsToSeconds = (milliseconds) => milliseconds / 1e3;

// src/node_modules/motion-utils/dist/es/velocity-per-second.mjs
function velocityPerSecond(velocity, frameDuration) {
  return frameDuration ? velocity * (1e3 / frameDuration) : 0;
}

// src/node_modules/motion-utils/dist/es/warn-once.mjs
...
// src/node_modules/motion-utils/dist/es/wrap.mjs
var wrap = (min, max, v) => {
  const rangeSize = max - min;
  return ((v - min) % rangeSize + rangeSize) % rangeSize + min;
};

// src/node_modules/motion-utils/dist/es/easing/cubic-bezier.mjs
...
// src/node_modules/motion-utils/dist/es/easing/modifiers/mirror.mjs
var mirrorEasing = (easing) => (p) => p <= 0.5 ? easing(2 * p) / 2 : (2 - easing(2 * (1 - p))) / 2;

// src/node_modules/motion-utils/dist/es/easing/modifiers/reverse.mjs
var reverseEasing = (easing) => (p) => 1 - easing(1 - p);

// src/node_modules/motion-utils/dist/es/easing/back.mjs
var backOut = cubicBezier(0.33, 1.53, 0.69, 0.99);
var backIn = reverseEasing(backOut);
var backInOut = mirrorEasing(backIn);

// src/node_modules/motion-utils/dist/es/easing/anticipate.mjs
var anticipate = (p) => (p *= 2) < 1 ? 0.5 * backIn(p) : 0.5 * (2 - Math.pow(2, -10 * (p - 1)));

// src/node_modules/motion-utils/dist/es/easing/circ.mjs
var circIn = (p) => 1 - Math.sin(Math.acos(p));
var circOut = reverseEasing(circIn);
var circInOut = mirrorEasing(circIn);

// src/node_modules/motion-utils/dist/es/easing/ease.mjs
var easeIn = cubicBezier(0.42, 0, 1, 1);
var easeOut = cubicBezier(0, 0, 0.58, 1);
var easeInOut = cubicBezier(0.42, 0, 0.58, 1);

// src/node_modules/motion-utils/dist/es/easing/steps.mjs
...
// src/node_modules/motion-utils/dist/es/easing/utils/is-easing-array.mjs
var isEasingArray = (ease2) => {
  return Array.isArray(ease2) && typeof ease2[0] !== "number";
};

// src/node_modules/motion-utils/dist/es/easing/utils/get-easing-for-segment.mjs
function getEasingForSegment(easing, i) {
  return isEasingArray(easing) ? easing[wrap(0, easing.length, i)] : easing;
}

// src/node_modules/motion-utils/dist/es/easing/utils/is-bezier-definition.mjs
var isBezierDefinition = (easing) => Array.isArray(easing) && typeof easing[0] === "number";

// src/node_modules/motion-utils/dist/es/easing/utils/map.mjs
var easingLookup = {
  linear: noop,
  easeIn,
  easeInOut,
...
// src/node_modules/motion-dom/dist/es/frameloop/order.mjs
var stepsOrder = [
  "setup",
  // Compute
  "read",
...
// src/node_modules/motion-dom/dist/es/stats/buffer.mjs
var statsBuffer = {
  value: null,
  addProjectionMetrics: null
};

// src/node_modules/motion-dom/dist/es/frameloop/render-step.mjs
...
// src/node_modules/motion-dom/dist/es/frameloop/batcher.mjs
var maxElapsed = 40;
...
// src/node_modules/motion-dom/dist/es/frameloop/frame.mjs
var { schedule: frame, cancel: cancelFrame, state: frameData, steps: frameSteps } = createRenderBatcher(typeof requestAnimationFrame !== "undefined" ? requestAnimationFrame : noop, true);

// src/node_modules/motion-dom/dist/es/frameloop/sync-time.mjs
var now;
function clearTime() {
  now = void 0;
}
...
// src/node_modules/motion-dom/dist/es/stats/animation-count.mjs
...
// src/node_modules/motion-dom/dist/es/animation/utils/is-css-variable.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/numbers/index.mjs
var number = {
...
// src/node_modules/motion-dom/dist/es/value/types/utils/sanitize.mjs
var sanitize = (v) => Math.round(v * 1e5) / 1e5;

// src/node_modules/motion-dom/dist/es/value/types/utils/float-regex.mjs
var floatRegex = /-?(?:\d+(?:\.\d+)?|\.\d+)/gu;

// src/node_modules/motion-dom/dist/es/value/types/utils/is-nullish.mjs
function isNullish(v) {
  return v == null;
}

// src/node_modules/motion-dom/dist/es/value/types/utils/single-color-regex.mjs
var singleColorRegex = /^(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))$/iu;

// src/node_modules/motion-dom/dist/es/value/types/color/utils.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/color/rgba.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/color/hex.mjs
function parseHex(v) {
  let r = "";
  let g = "";
  let b = "";
...
// src/node_modules/motion-dom/dist/es/value/types/numbers/units.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/color/hsla.mjs
var hsla = {
...
// src/node_modules/motion-dom/dist/es/value/types/color/index.mjs
var color = {
...
// src/node_modules/motion-dom/dist/es/value/types/utils/color-regex.mjs
var colorRegex = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu;

// src/node_modules/motion-dom/dist/es/value/types/complex/index.mjs
function test(v) {
  var _a, _b;
...
// src/node_modules/motion-dom/dist/es/value/types/color/hsla-to-rgba.mjs
...
// src/node_modules/motion-dom/dist/es/utils/mix/immediate.mjs
function mixImmediate(a, b) {
  return (p) => p > 0 ? b : a;
}

// src/node_modules/motion-dom/dist/es/utils/mix/number.mjs
var mixNumber = (from, to, progress2) => {
  return from + (to - from) * progress2;
};

// src/node_modules/motion-dom/dist/es/utils/mix/color.mjs
...
// src/node_modules/motion-dom/dist/es/utils/mix/visibility.mjs
...
// src/node_modules/motion-dom/dist/es/utils/mix/complex.mjs
...
// src/node_modules/motion-dom/dist/es/utils/mix/index.mjs
...
// src/node_modules/motion-dom/dist/es/animation/drivers/frame.mjs
...
// src/node_modules/motion-dom/dist/es/animation/waapi/utils/linear.mjs
...
// src/node_modules/motion-dom/dist/es/animation/generators/utils/calc-duration.mjs
...
// src/node_modules/motion-dom/dist/es/animation/generators/utils/create-generator-easing.mjs
...
// src/node_modules/motion-dom/dist/es/animation/generators/utils/velocity.mjs
...
// src/node_modules/motion-dom/dist/es/animation/generators/spring/defaults.mjs
var springDefaults = {
...
// src/node_modules/motion-dom/dist/es/animation/generators/spring/find.mjs
var safeMin = 1e-3;
...
// src/node_modules/motion-dom/dist/es/animation/generators/spring/index.mjs
...
// src/node_modules/motion-dom/dist/es/animation/generators/inertia.mjs
...
// src/node_modules/motion-dom/dist/es/utils/interpolate.mjs
...
// src/node_modules/motion-dom/dist/es/animation/keyframes/offsets/fill.mjs
...
// src/node_modules/motion-dom/dist/es/animation/keyframes/offsets/default.mjs
...
// src/node_modules/motion-dom/dist/es/animation/keyframes/offsets/time.mjs
function convertOffsetToTimes(offset, duration) {
  return offset.map((o) => o * duration);
}

// src/node_modules/motion-dom/dist/es/animation/generators/keyframes.mjs
...
// src/node_modules/motion-dom/dist/es/animation/keyframes/get-final.mjs
...
// src/node_modules/motion-dom/dist/es/animation/utils/replace-transition-type.mjs
...
// src/node_modules/motion-dom/dist/es/animation/utils/WithPromise.mjs
...
// src/node_modules/motion-dom/dist/es/animation/JSAnimation.mjs
...
// src/node_modules/motion-dom/dist/es/animation/keyframes/utils/fill-wildcards.mjs
...
// src/node_modules/motion-dom/dist/es/render/dom/parse-transform.mjs
...
// src/node_modules/motion-dom/dist/es/render/utils/keys-transform.mjs
...
// src/node_modules/motion-dom/dist/es/animation/keyframes/utils/unit-conversion.mjs
...
// src/node_modules/motion-dom/dist/es/animation/keyframes/KeyframesResolver.mjs
...
// src/node_modules/motion-dom/dist/es/render/dom/is-css-var.mjs
var isCSSVar = (name) => name.startsWith("--");

// src/node_modules/motion-dom/dist/es/render/dom/style-set.mjs
function setStyle(element, name, value) {
  isCSSVar(name) ? element.style.setProperty(name, value) : element.style[name] = value;
}

// src/node_modules/motion-dom/dist/es/utils/supports/scroll-timeline.mjs
var supportsScrollTimeline = memo(() => window.ScrollTimeline !== void 0);

// src/node_modules/motion-dom/dist/es/utils/supports/flags.mjs
var supportsFlags = {};

// src/node_modules/motion-dom/dist/es/utils/supports/memo.mjs
function memoSupports(callback, supportsFlag) {
  const memoized = memo(callback);
  return () => supportsFlags[supportsFlag] ?? memoized();
}

// src/node_modules/motion-dom/dist/es/utils/supports/linear-easing.mjs
...
// src/node_modules/motion-dom/dist/es/animation/waapi/easing/cubic-bezier.mjs
var cubicBezierAsString = ([a, b, c, d]) => `cubic-bezier(${a}, ${b}, ${c}, ${d})`;

// src/node_modules/motion-dom/dist/es/animation/waapi/easing/supported.mjs
...
// src/node_modules/motion-dom/dist/es/animation/waapi/easing/map-easing.mjs
...
// src/node_modules/motion-dom/dist/es/animation/waapi/start-waapi-animation.mjs
...
// src/node_modules/motion-dom/dist/es/animation/generators/utils/is-generator.mjs
function isGenerator(type) {
  return typeof type === "function" && "applyToOptions" in type;
}

// src/node_modules/motion-dom/dist/es/animation/waapi/utils/apply-generator.mjs
...
// src/node_modules/motion-dom/dist/es/animation/NativeAnimation.mjs
...
// src/node_modules/motion-dom/dist/es/animation/waapi/utils/unsupported-easing.mjs
...
// src/node_modules/motion-dom/dist/es/animation/NativeAnimationExtended.mjs
var sampleDelta = 10;
...
// src/node_modules/motion-dom/dist/es/animation/utils/is-animatable.mjs
...
// src/node_modules/motion-dom/dist/es/animation/utils/can-animate.mjs
...
// src/node_modules/motion-dom/dist/es/animation/utils/make-animation-instant.mjs
function makeAnimationInstant(options) {
  options.duration = 0;
  options.type = "keyframes";
}

// src/node_modules/motion-dom/dist/es/animation/waapi/supports/waapi.mjs
...
// src/node_modules/motion-dom/dist/es/animation/AsyncMotionValueAnimation.mjs
...
// src/node_modules/motion-dom/dist/es/animation/GroupAnimation.mjs
...
// src/node_modules/motion-dom/dist/es/animation/GroupAnimationWithThen.mjs
...
// src/node_modules/motion-dom/dist/es/animation/NativeAnimationWrapper.mjs
...
// src/node_modules/motion-dom/dist/es/animation/utils/active-animations.mjs
...
// src/node_modules/motion-dom/dist/es/animation/utils/css-variables-conversion.mjs
...
// src/node_modules/motion-dom/dist/es/animation/utils/get-value-transition.mjs
function getValueTransition(transition, key) {
  return (transition == null ? void 0 : transition[key]) ?? (transition == null ? void 0 : transition["default"]) ?? transition;
}

// src/node_modules/motion-dom/dist/es/render/utils/keys-position.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/auto.mjs
var auto = {
  test: (v) => v === "auto",
  parse: (v) => v
};

// src/node_modules/motion-dom/dist/es/value/types/test.mjs
var testValueType = (v) => (type) => type.test(v);

// src/node_modules/motion-dom/dist/es/value/types/dimensions.mjs
var dimensionValueTypes = [number, px, percent, degrees, vw, vh, auto];
var findDimensionValueType = (v) => dimensionValueTypes.find(testValueType(v));

// src/node_modules/motion-dom/dist/es/animation/keyframes/utils/is-none.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/complex/filter.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/int.mjs
var int = {
  ...number,
  transform: Math.round
};

// src/node_modules/motion-dom/dist/es/value/types/maps/transform.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/maps/number.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/maps/defaults.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/utils/animatable-none.mjs
...
// src/node_modules/motion-dom/dist/es/animation/keyframes/utils/make-none-animatable.mjs
...
// src/node_modules/motion-dom/dist/es/animation/keyframes/DOMKeyframesResolver.mjs
...
// src/node_modules/motion-dom/dist/es/animation/waapi/utils/px-values.mjs
...
// src/node_modules/motion-dom/dist/es/animation/keyframes/utils/apply-px-defaults.mjs
...
// src/node_modules/motion-dom/dist/es/animation/waapi/easing/is-supported.mjs
function isWaapiSupportedEasing(easing) {
  return Boolean(typeof easing === "function" && supportsLinearEasing() || !easing || typeof easing === "string" && (easing in supportedWaapiEasing || supportsLinearEasing()) || isBezierDefinition(easing) || Array.isArray(easing) && easing.every(isWaapiSupportedEasing));
}

// src/node_modules/motion-dom/dist/es/animation/waapi/supports/partial-keyframes.mjs
...
// src/node_modules/motion-dom/dist/es/animation/waapi/utils/accelerated-values.mjs
...
// src/node_modules/motion-dom/dist/es/render/dom/utils/camel-to-dash.mjs
function camelToDash(str) {
  return str.replace(/([A-Z])/g, (match) => `-${match.toLowerCase()}`);
}

// src/node_modules/motion-dom/dist/es/utils/resolve-elements.mjs
...
// src/node_modules/motion-dom/dist/es/effects/utils/create-dom-effect.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/utils/get-as-type.mjs
var getValueAsType = (value, type) => {
  return type && typeof value === "number" ? type.transform(value) : value;
};

// src/node_modules/motion-dom/dist/es/effects/MotionValueState.mjs
...
// src/node_modules/motion-dom/dist/es/effects/utils/create-effect.mjs
...
// src/node_modules/motion-dom/dist/es/effects/attr/index.mjs
...
// src/node_modules/motion-dom/dist/es/effects/prop/index.mjs
...
// src/node_modules/motion-dom/dist/es/utils/is-html-element.mjs
function isHTMLElement(element) {
  return isObject(element) && "offsetHeight" in element;
}

// src/node_modules/motion-dom/dist/es/value/index.mjs
...
// src/node_modules/motion-dom/dist/es/effects/style/transform.mjs
var translateAlias = {
  x: "translateX",
  y: "translateY",
  z: "translateZ",
...
// src/node_modules/motion-dom/dist/es/effects/style/index.mjs
...
// src/node_modules/motion-dom/dist/es/effects/svg/index.mjs
...
// src/node_modules/motion-dom/dist/es/frameloop/microtask.mjs
var { schedule: microtask, cancel: cancelMicrotask } = createRenderBatcher(queueMicrotask, false);

// src/node_modules/motion-dom/dist/es/gestures/drag/state/is-active.mjs
var isDragging = {
  x: false,
  y: false
};
...
// src/node_modules/motion-dom/dist/es/gestures/drag/state/set-active.mjs
...
// src/node_modules/motion-dom/dist/es/gestures/utils/setup.mjs
...
// src/node_modules/motion-dom/dist/es/gestures/hover.mjs
...
// src/node_modules/motion-dom/dist/es/gestures/utils/is-node-or-child.mjs
...
// src/node_modules/motion-dom/dist/es/gestures/utils/is-primary-pointer.mjs
...
// src/node_modules/motion-dom/dist/es/gestures/press/utils/is-keyboard-accessible.mjs
...
// src/node_modules/motion-dom/dist/es/gestures/press/utils/state.mjs
var isPressing = /* @__PURE__ */ new WeakSet();

// src/node_modules/motion-dom/dist/es/gestures/press/utils/keyboard.mjs
...
// src/node_modules/motion-dom/dist/es/gestures/press/index.mjs
...
// src/node_modules/motion-dom/dist/es/render/dom/style-computed.mjs
...
// src/node_modules/motion-dom/dist/es/utils/is-svg-element.mjs
function isSVGElement(element) {
  return isObject(element) && "ownerSVGElement" in element;
}

// src/node_modules/motion-dom/dist/es/resize/handle-element.mjs
...
// src/node_modules/motion-dom/dist/es/resize/handle-window.mjs
...
// src/node_modules/motion-dom/dist/es/resize/index.mjs
function resize(a, b) {
  return typeof a === "function" ? resizeWindow(a) : resizeElement(a, b);
}

// src/node_modules/motion-dom/dist/es/scroll/observe.mjs
...
// src/node_modules/motion-dom/dist/es/stats/index.mjs
function record() {
...
// src/node_modules/motion-dom/dist/es/utils/is-svg-svg-element.mjs
function isSVGSVGElement(element) {
  return isSVGElement(element) && element.tagName === "svg";
}

// src/node_modules/motion-dom/dist/es/utils/stagger.mjs
...
// src/node_modules/motion-dom/dist/es/utils/transform.mjs
...
// src/node_modules/motion-dom/dist/es/value/subscribe-value.mjs
...
// src/node_modules/motion-dom/dist/es/value/transform-value.mjs
...
// src/node_modules/motion-dom/dist/es/value/map-value.mjs
function mapValue(inputValue, inputRange, outputRange, options) {
  const map = transform(inputRange, outputRange, options);
  return transformValue(() => map(inputValue.get()));
}

// src/node_modules/motion-dom/dist/es/value/utils/is-motion-value.mjs
var isMotionValue = (value) => Boolean(value && value.getVelocity);

// src/node_modules/motion-dom/dist/es/value/spring-value.mjs
...
// src/node_modules/motion-dom/dist/es/value/types/utils/find.mjs
var valueTypes = [...dimensionValueTypes, color, complex];
var findValueType = (v) => valueTypes.find(testValueType(v));

// src/node_modules/motion-dom/dist/es/view/utils/choose-layer-type.mjs
...
// src/node_modules/motion-dom/dist/es/view/utils/css.mjs
var pendingRules = {};
var style = null;
var css = {
  set: (selector, values) => {
...
// src/node_modules/motion-dom/dist/es/view/utils/get-layer-info.mjs
...
// src/node_modules/motion-dom/dist/es/view/utils/get-view-animations.mjs
...
// src/node_modules/motion-dom/dist/es/view/utils/has-target.mjs
function hasTarget(target, targets) {
  return targets.has(target) && Object.keys(targets.get(target)).length > 0;
}

// src/node_modules/motion-dom/dist/es/view/start.mjs
...
// src/node_modules/motion-dom/dist/es/view/queue.mjs
var builders = [];
var current = null;
function next() {
  current = null;
...
// src/node_modules/motion-dom/dist/es/view/index.mjs
...
// src/node_modules/motion-dom/dist/es/frameloop/index-legacy.mjs
var sync = frame;
...
// src/node_modules/framer-motion/dist/es/utils/use-composed-ref.mjs
...
// src/node_modules/framer-motion/dist/es/render/html/use-html-visual-state.mjs
...
// src/node_modules/framer-motion/dist/es/render/svg/use-svg-visual-state.mjs
...
// src/node_modules/framer-motion/dist/es/animation/utils/calc-child-stagger.mjs
...
// src/node_modules/framer-motion/dist/es/render/components/motion/feature-bundle.mjs
var featureBundle = {
  ...animations,
  ...gestureAnimations,
  ...drag,
...
// src/node_modules/framer-motion/dist/es/render/dom/scroll/utils/get-timeline.mjs
...
// src/node_modules/framer-motion/dist/es/render/dom/scroll/attach-animation.mjs
...
// src/node_modules/framer-motion/dist/es/render/dom/scroll/attach-function.mjs
...
// src/node_modules/framer-motion/dist/es/components/AnimatePresence/use-presence-data.mjs
...
// src/node_modules/framer-motion/dist/es/utils/use-page-in-view.mjs
